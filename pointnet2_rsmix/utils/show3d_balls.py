...
def showpoints(xyz,c_gt=None, c_pred = None ,waittime=0,showrot=False,magnifyBlue=0,
               freezerot=False,background=(0,0,0),normalizecolor=True, ballradius=10, mixed_color=False, lam=0.0, save_name='_'):
    ...
    # elif args.origin: # original a
        
    # elif args.origin_2: # original b
...
if __name__=='__main__':
    ...
    parser.add_argument('--origin', action='store_true', help='origin')
    parser.add_argument('--origin_2', action='store_true', help='origin')
    ...
    showpoints(point_set, showrot=args.show_rot, freezerot=args.freeze_rot,background=c_background,
               normalizecolor=args.not_normalize_color,ballradius=args.ball_radius, mixed_color=args.mixed_color, lam=lam, save_name=filename)
